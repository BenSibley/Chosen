<div id="post-meta" class="post-meta">
	...
	<div class="post-comments">
		...
		if( ! comments_open() && get_comments_number() < 1 ) :
			comments_number( __( 'Comments closed', 'chosen' ), __( 'One Comment', 'chosen'), __( '% Comments', 'chosen' ) );
		else :
			echo '<a href="' . get_comments_link() . '">';
				comments_number( __( 'Leave a Comment', 'chosen' ), __( 'One Comment', 'chosen'), __( '% Comments', 'chosen' ) );
			echo '</a>';
		endif;
		?>
	</div>
