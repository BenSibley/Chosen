...
<section id="comments" class="comments">
  ...
  if ( comments_open() ) {
    ...
    <p class="comments-closed pings-open">
      ...
      echo wp_kses_post( sprintf( __( 'Comments are closed, but <a href="%s" title="Trackback URL for this post">trackbacks</a> and pingbacks are open.', 'chosen' ), esc_url( get_trackback_url() ) ) );
      ?>
    </p>
